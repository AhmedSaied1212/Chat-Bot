...
const Chatbot = () => {
    ...
    return (
        <div className="font-sans min-h-screen relative  w-full mx-auto mt-0 p-6 bg-gradient-to-br from-gray-50 to-white space-y-4">
            <Header />
                        ...
                        <div className={`max-w-[75%] ${msg.sender === 'user' ? 'text-right' : 'text-left'}`}>
                            <div className={`inline-block p-3 rounded-xl text-base break-words ${
                                msg.sender === 'user'
                                    ...
                                    : msg.sender === 'bot'
                                    ? 'bg-gray-100 tracking-wide  text-wrap text-gray-800 rounded-bl-none shadow-md'
